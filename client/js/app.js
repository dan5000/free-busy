var app = angular.module('FreeBusy', ['ionic', 'FreeBusy.services', 'FreeBusy.controllers','jmdobry.angular-cache', 'ngCordova'])
...
var controllers = angular.module('FreeBusy.controllers', []);
var services = angular.module('FreeBusy.services', []);
